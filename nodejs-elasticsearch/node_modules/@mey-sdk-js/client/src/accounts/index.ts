...
import { TxBody } from '@mey-sdk-js/common';

/**
 * Accounts controller. It is exposed at `meyClient.accounts`.
 */
class Accounts {
    client: any;
    mey: any;
    ...
    sendTransaction(_tx: TxBody | Tx): Promise<string> {
        ...
        if (typeof tx.limit === 'undefined' && this.mey.defaultLimit) {
            tx.limit = this.mey.defaultLimit;
        }
